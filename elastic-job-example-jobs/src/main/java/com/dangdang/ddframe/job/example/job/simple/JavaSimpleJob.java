...
public class JavaSimpleJob implements SimpleJob {
    ...
    public void execute(final ShardingContext shardingContext) {
        System.out.println(String.format("total: %s |Item: %s | Time: %s | Thread: %s | %s",
                shardingContext.getShardingTotalCount(),shardingContext.getShardingItem(), new SimpleDateFormat("HH:mm:sss").format(new Date()), Thread.currentThread().getId(), "SIMPLE"));
